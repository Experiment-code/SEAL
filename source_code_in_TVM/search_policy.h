...
class SearchPolicyNode : public Object {
 public:
  ...
  /*virtual State Search_without_measure(int num_measure_trials, int early_stopping, int num_measures_per_round,
	  ProgramMeasurer measurer) = 0;*/
  ...
  /*virtual Array<MeasureInput> ContinueSearchOneRound_without_measure(
	  int num_measure, ProgramMeasurer measurer) = 0;*/
