...
//TVM_REGISTER_GLOBAL("auto_scheduler.SearchPolicySearchWithoutMeasure")
//.set_body_typed([](SearchPolicy policy, int n_trials, int early_stopping, int num_measure_per_iter, ProgramMeasurer measurer) {
//	State best_state;
...
//TVM_REGISTER_GLOBAL("auto_scheduler.SearchPolicyContinueSearchOneRoundWithoutMeasure")
//.set_body_typed([](SearchPolicy policy, int num_measure, ProgramMeasurer measurer) {
//	Array<MeasureInput> inputs;
